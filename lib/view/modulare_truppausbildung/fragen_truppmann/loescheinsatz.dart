class Loescheinsatz {
  static const String themengebiet = "Löscheinsatz";

  static final fragenLoescheinsatz = [
    {
      'questionText':
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text': 'Keine Festlegung, da der Arbeitsaufwand gleich is',
          'score': 0
        },
        {
          'text':
