class ErsteHilfe {
  static const String themengebiet = "Erste Hilfe";
  ...
  static final fragenRettungVonPersonen = [
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'Sofern keine akute Gefahr durch Brand, Bewusstlosigkeit ä. besteht, sollen Verletzte im Fahrzeug verbleiben bis der Rettungsdienst die medizinischeLage beurteilt hat',
          'score': 1
        }
      ]
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'Ich spreche die Person laut an. Ich schüttle an den Schultern, kontrolliere Mund und Rachenraum, stelle die Atmung fest',
          'score': 1
        },
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'Ich leiste Erste Hilfe. Sage, dass ich für sie da bin, dass der Rettungsdienst informiert ist. Ich spreche ihr gut zu und höre zu',
          'score': 1
        },
        {
